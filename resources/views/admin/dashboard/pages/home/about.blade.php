...
<div class="flex flex-col gap-3">
    <div class="container mx-auto px-4 py-4 border-black border rounded-lg">
        <h2 class="text-2xl font-bold mb-4">Feedback Client</h2>
        <form>
            @csrf
            <div class="mb-4">
    ...
    <div id="editModal-style" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden flex items-center justify-center">
        <div class="bg-white p-6 rounded-lg w-1/3">
            <h2 class="text-2xl font-bold mb-4">Edit Feedback Card</h2>
            <form id="editCategoryForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <!-- CKEditor 5 akan diterapkan pada elemen div ini -->
    ...
    document.body.addEventListener('click', function (e) {
        if (e.target && e.target.classList.contains('edit-button-style')) {
            ...
            document.getElementById('editImage').setAttribute('src', categoryImage);
            ...
            // Inisialisasi CKEditor 5 pada elemen div editDescription
            ClassicEditor
                ...
                .catch(error => {
                    console.error('Terjadi kesalahan saat menginisialisasi CKEditor:', error);
                });
    ...
    document.getElementById('closeEditModalButton').addEventListener('click', function () {
        ...
        if (editorInstance) {
            editorInstance.destroy();
            editorInstance = null; // Set null agar instance baru dapat dibuat
        }
    });
